...
make load-test                            # fire whole rate-limit budgets at the running stack
...
| [`docs/adr/`](docs/adr) | Architecture decision records (ADR-009 … ADR-035) |
