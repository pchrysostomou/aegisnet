...
- [x] `README.md`, `ARCHITECTURE.md`, `THREAT_MODEL.md`, `SECURITY.md`, `docs/STATUS.md`, `docs/detection-rules.md`, `docs/evaluation.md`, `docs/perplexity-integration.md` all current. — all seven exist and were re-read against the code in Chunk 31's claims audit, which found nineteen stale statements in them.
