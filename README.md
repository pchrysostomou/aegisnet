...
<p align="center">
  <a href="docs/screenshots/incident-case.png"><img src="docs/screenshots/incident-queue.png" width="880" alt="The incident queue: three cases opened by correlation from the committed scenario. One is critical, four rules agreeing about one host; the other two are single port-scan alerts."></a>
</p>

<p align="center"><sub>The incident queue on the committed multi-stage scenario — click through for
<a href="docs/screenshots/incident-case.png">the case it opens</a>. Generated by one command, not taken, and everything in it is synthetic
(<a href="docs/screenshots/README.md">how</a>).</sub></p>

**New here?** [`docs/overview.md`](docs/overview.md) is the two-minute version: what it is, what
is worth looking at, and what it does not claim. The rest of this page is the reference.
...
| [`docs/overview.md`](docs/overview.md) | The two-minute version of this page, with the case view, for somebody deciding whether to read the rest |
