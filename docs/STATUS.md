...
1. SonarCloud passes (E-41). To show the quality-gate badge in the README and open the dashboard's API, make the SonarCloud project public (Project Settings → Visibility); nothing in the analysis depends on it.
