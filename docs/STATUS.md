...
| | |
|---|---|
| Phase | **Milestone 2 in progress — Chunk 8 (detector contract, severity formula, D-001 port scan with labelled fixtures) verified locally (E-44) and in CI (E-45); Chunk 9 (detection schema, alert store, sweep, alerts API) next** |
