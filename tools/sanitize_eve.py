...
CHECKED_TLDS = frozenset(
    """com net org test example io dev local gov edu mil info biz co uk de fr nl eu ru cn jp
    us ca au ch se no es it pl br in xyz online site top cloud app ai me tv cc ly sh id""".split()
)
