...
| M1 Foundation / ingest / normalize / assets | 🟡 In progress — Chunks 1–5 done | E-1 – E-8, E-18 – E-33 | Next: Chunk 6 auth, RBAC, audit, rate limits, routes |
...
| 6 | Auth, RBAC, audit, rate limits, `SECURITY.md` | ✅ Verified locally (E-34 – E-37); CI confirmation pending (E-38) |
...
3. Chunk 6 is verified locally (E-34 – E-37); confirm it in CI (E-38): the `stack` job now creates a user and a service token through the CLI, proves the unauthenticated `401`, ingests the corpus over HTTP and reads the finished batch as the user.
